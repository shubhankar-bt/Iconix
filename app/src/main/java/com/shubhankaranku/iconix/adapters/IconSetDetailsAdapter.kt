...
class IconSetDetailsAdapter : RecyclerView.Adapter<IconSetDetailsAdapter.MyViewHolder>() {
    ...
    private val diffUtilCallback =
        object : DiffUtil.ItemCallback<com.shubhankaranku.iconix.model.allIconsInIconSet.Icon>() {
            override fun areItemsTheSame(
                oldItem: com.shubhankaranku.iconix.model.allIconsInIconSet.Icon,
                newItem: com.shubhankaranku.iconix.model.allIconsInIconSet.Icon
            ): Boolean {
    ...
    private var onItemClickListener: ((com.shubhankaranku.iconix.model.allIconsInIconSet.Icon) -> Unit)? =
        null

    fun setOnItemClickListener(listener: (com.shubhankaranku.iconix.model.allIconsInIconSet.Icon) -> Unit) {
